...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bootstrapSass = __webpack_require__(221);
	...
	exports.default = _react2.default.createClass({
	  ...
	  onHandleHeart: function onHandleHeart(e) {
	    var changeState = {};
	    changeState[_reactDom2.default.findDOMNode(e.target).dataset.id] = !this.state[_reactDom2.default.findDOMNode(e.target).dataset.id];
	        ...
	        this.props.shirts.map(function (resp, i) {
	          return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                { id: resp.id, className: 'carousel', 'data-ride': 'carousel', 'data-interval': 'false' },
	                _react2.default.createElement(
	                  'div',
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('img', { className: 'shirt__image', src: resp.imageUrlFront })
	                  ),
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'item' },
	                    _react2.default.createElement('img', { className: 'shirt__image', src: resp.imageUrlBack })
	                  )
	                ),
	                _react2.default.createElement(
	                  'a',
	                  { className: 'carousel-swap', href: '#' + resp.id, role: 'button', 'data-slide': 'prev' },
	                  _react2.default.createElement('span', { className: 'flip glyphicon glyphicon-share' })
	                )
	              ),
	              _react2.default.createElement(
	                'div',
	                { className: 'btn-group bar' },
	                _react2.default.createElement(
	                  'div',
	                  null,
	                  _react2.default.createElement(
	                    'button',
	                    { className: 'btn btn-default bar__el' },
	                    _react2.default.createElement('span', { className: 'glyphicon glyphicon-retweet icon carousel-swap', href: '#' + resp.id, 'data-slide': 'prev' })
	                  ),
	                  _react2.default.createElement(
	                    'button',
	                    { className: 'btn btn-default bar__el', onClick: this.onHandleHeart },
	                    _react2.default.createElement('span', { 'data-id': resp.id, className: 'icon glyphicon ' + (this.state[resp.id] ? "glyphicon-heart" : "glyphicon-heart-empty") })
	                  ),
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'dropup dropup__button' },
	                    _react2.default.createElement(
	                      'button',
	                      { className: 'btn btn-default bar__el', type: 'button', 'data-toggle': 'dropdown', 'aria-haspopup': 'true', 'aria-expanded': 'false' },
	                      _react2.default.createElement(
	                        'span',
	                  ...
	                  _react2.default.createElement(
	                    'div',
	                    { className: 'dropup dropup__button test' },
	                    _react2.default.createElement(
	                      'button',
	                      { className: 'btn btn-default bar__el dropdown-toggle square__wrapper', type: 'button', 'data-toggle': 'dropdown', 'aria-haspopup': 'true', 'aria-expanded': 'false' },
	                      _react2.default.createElement('div', { className: 'color__square' })
	                    ),
	                    _react2.default.createElement(
	                      'ul',
	                      { className: 'dropdown-menu dropup__wrapper' },
	                      _react2.default.createElement(
	                        'li',
	                        { className: 'square__wrapper' },
	                        _react2.default.createElement('div', { className: 'color__square color__square--1' })
	                      ),
	                      _react2.default.createElement(
	                        'li',
	                        { className: 'square__wrapper' },
	                        _react2.default.createElement('div', { className: 'color__square color__square--2' })
	                      ),
	                      _react2.default.createElement(
	                        'li',
	                        { className: 'square__wrapper' },
	                        _react2.default.createElement('div', { className: 'color__square color__square--3' })
	                      ),
	                      _react2.default.createElement(
	                        'li',
	                        { className: 'square__wrapper' },
	                  ...
	                  _react2.default.createElement(
	                    'button',
	                    { className: 'btn btn-default bar__el' },
	                    _react2.default.createElement('span', { className: 'glyphicon glyphicon-shopping-cart icon' })
	                  )
	                )
	              ),
	              _react2.default.createElement(
